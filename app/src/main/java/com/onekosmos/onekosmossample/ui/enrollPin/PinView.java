package com.onekosmos.onekosmossample.ui.enrollPin;
...
public class PinView extends AppCompatEditText {
    ...
    private int mViewType, mPinItemCount, mPinItemWidth, mPinItemHeight, mPinItemRadius, mPinItemSpacing;
    ...
    /**
     * These method is used to display the pin ui in pin enroll activity
     *
     * @param context
     * @param attrs
     * @param defStyleAttr
    ...
    public PinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mPinItemHeight = (int) a.getDimension(R.styleable.PinView_itemHeight, res.getDimensionPixelSize(R.dimen.dimen_48dp));
        mPinItemWidth = (int) a.getDimension(R.styleable.PinView_itemWidth, res.getDimensionPixelSize(R.dimen.dimen_48dp));
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.PinView_itemSpacing, res.getDimensionPixelSize(R.dimen.dimen_5dp));
        mPinItemRadius = (int) a.getDimension(R.styleable.PinView_itemRadius, 0);
        mLineWidth = (int) a.getDimension(R.styleable.PinView_lineWidth, res.getDimensionPixelSize(R.dimen.dimen_2dp));
        ...
        mForceKeyboard = a.getBoolean(R.styleable.PinView_forceKeyboard, mForceKeyboard);
        isFocusable = a.getBoolean(R.styleable.PinView_focusable, true);
        mCursorColor = a.getColor(R.styleable.PinView_cursorColor, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(R.styleable.PinView_cursorWidth, res.getDimensionPixelSize(R.dimen.dimen_2dp));
    ...
    /**
     * These method is used to set the type of text animator or style while typing the pin
     *
     * @param tf
     */
    @Override
    ...
    /**
     * These method is used to set the max length of the pin password
     *
     * @param maxLength
     */
    ...
    /**
     * These method is used to set the animation of pin view
     */
    ...
    private void drawCircle(Canvas canvas, int i) {
        ...
        float cx = mItemCenterPoint.x;
        float cy = mItemCenterPoint.y;
        canvas.drawCircle(cx, cy, paint.getTextSize() / 6, paint);
    }
