 ...
 */
public class LiveIDScanningV2Activity extends AppCompatActivity implements View.OnClickListener, LiveIDScannerHelper.ILiveIDResponseListenerV2 {
    ...
    private void initViews() {
        ...
        mTxtTitle.setText(getString(R.string.label_enroll_liveid_v2));
